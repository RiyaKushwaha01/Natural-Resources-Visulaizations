...
fig1, ax1 = plt.subplots(figsize=(8,4))  # Adjust size here
...
fig2, ax2 = plt.subplots(figsize=(4,4))  # Adjust size here
...
Revenue_LandCategory.plot(kind='bar', figsize=(4,4), ax=ax3)
ax3.set_ylabel("")
...
State_Revenue.plot(kind='bar', width=0.7, figsize=(4,4), ax=ax4)
ax4.set_ylabel("")
...
County_Revenue.plot(kind='bar', figsize=(4,4), ax=ax6)
ax6.set_ylabel("")
...
Offshore_Revenue.plot(kind='bar', figsize=(4,4), ax=ax7)
ax7.set_ylabel("")
...
RevenuebyCommodityMineralLease.plot(kind='bar', figsize=(4,4), ax=ax8)
ax8.set_ylabel("")
...
Revenue_Rev_Type.plot(kind='barh', figsize=(4,4), ax=ax9)
